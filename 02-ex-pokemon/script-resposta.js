...
console.log("Veja a lista dos Pokemons:")
...
console.log("Veja a descrição de cada Pokemon:")
for (let i = 0; i < data.length; i++) {
    let pokemon = data[i] 
    console.table(pokemon.name + " --> " +  pokemon.description) 
}

console.log("Veja o tipo de cada Pokemon:")
for (let i = 0; i < data.length; i++) {
        let pokemon = data[i]
        let pokemonType = data[i]
       console.log(pokemon.name + " --> " + pokemonType.types)
    }
